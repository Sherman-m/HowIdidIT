...
async function handlerEditTopic(userId, topicId) {
    ...
    if (loadTopicResponse.ok) {
        ...
        if (dataTopic.user.userId === userId) {
            document.getElementById("buttons-for-topic-header").innerHTML += '<button type="button" class="btn-edit">\n' +
            ...
            document.getElementById("buttons-for-topic-header").innerHTML += '<button type="button" class="btn-delete">\n' +
            ...
            let buttonEditTopic = document.querySelector("#buttons-for-topic-header > .btn-edit");
            let buttonDeleteTopic = document.querySelector("#buttons-for-topic-header > .btn-delete");
