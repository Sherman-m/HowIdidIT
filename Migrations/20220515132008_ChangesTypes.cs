        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    count_of_discussing = table.Column<int>(type: "integer", nullable: false),
                    date_of_creating = table.Column<DateTime>(type: "timestamp", nullable: true),
                    last_added = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_types_of_users", x => x.type_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_of_registration = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    topic_id = table.Column<int>(type: "integer", nullable: false),
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    count_of_messages = table.Column<int>(type: "integer", nullable: true),
                    date_of_creating = table.Column<DateTime>(type: "timestamp", nullable: true),
                    last_modification = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    discussion_id = table.Column<int>(type: "integer", nullable: false),
                    date_of_publication = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
